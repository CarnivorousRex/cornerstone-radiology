...
/*				if ($.fullscreen.isFullScreen()) {
					...
					$("div.viewport canvas").removeClass("bottom");
				...
				$(".viewer").fullscreen();
					...
					$("div.viewer").eq(0).addClass("fullscreen-style");
					$("div.viewport canvas").eq(0).addClass("fullscreen-style");
					$("div.viewport canvas").eq(0).addClass("bottom");
            ...
            case 'panmove':
                // calculate our current points in page and image coordinates
				console.log("I am trying to pan");
		...
		var thumbnail = $(".csthumbnail").get(0);
		if (!thumbnail.isEqualNode(e.target.parentNode)) {
        	console.log("Didn't touch the thumbnails");
			return false;
		} else { 
			console.log("did touch a thumbnail");
			return; 
		}
    }
